...
public class DecoderActivity extends AppCompatActivity
    ...
    @Override public void onQRCodeRead(String text, PointF[] points) {
        Log.d("Shit you need", text);
        SessionManager sessionManager = new SessionManager(DecoderActivity.this);
        sessionManager.setScannedCode(text);
        Intent intent = new Intent(getApplicationContext(), NewMain.class);
        intent.putExtra("EXTRA_NAME", DecoderActivity.class.getSimpleName());
